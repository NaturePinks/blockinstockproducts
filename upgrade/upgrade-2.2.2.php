...
function upgrade_module_2_2_2($module)
{
    ...
    Configuration::deleteByName('PS_BLOCK_INSTOCKPRODUCTS_TTL');
    Configuration::deleteByName('PS_BLOCK_INSTOCKPRODUCTS_TIMESTAMP');
    Configuration::deleteByName('PS_BLOCK_INSTOCKPRODUCTS_DISPLAY');
    Configuration::deleteByName('PS_BLOCK_INSTOCKPRODUCTS_TO_DISPLAY');
